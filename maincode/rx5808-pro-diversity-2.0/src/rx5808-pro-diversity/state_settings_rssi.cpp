    ...
    switch (internalState) {
        case InternalState::WAIT_FOR_LOW:
            ...
            Ui::display.setCursor(0, SCREEN_HEIGHT - CHAR_HEIGHT - 1);
                ...
                Ui::display.print(PSTR2("MODE when ready"));
            #else
        ...
        case InternalState::DONE:
            ...
            Ui::display.setCursor((CHAR_WIDTH + 1) * 4, CHAR_HEIGHT + 1);
            Ui::display.print(EepromSettings.rssiAMin);
            #ifdef USE_DIVERSITY
                Ui::display.setCursor((CHAR_WIDTH + 1) * 11, CHAR_HEIGHT + 1);
            ...
            Ui::display.setCursor((CHAR_WIDTH + 1) * 4, (CHAR_HEIGHT + 1) * 2);
            Ui::display.print(EepromSettings.rssiAMax);
            #ifdef USE_DIVERSITY
                Ui::display.setCursor((CHAR_WIDTH + 1) * 11,
                    (CHAR_HEIGHT + 1) * 2);
                Ui::display.print(EepromSettings.rssiBMax);
            #endif

            Ui::display.setCursor(0, SCREEN_HEIGHT - CHAR_HEIGHT - 1);
            Ui::display.print(PSTR2("MODE to save"));
#else
